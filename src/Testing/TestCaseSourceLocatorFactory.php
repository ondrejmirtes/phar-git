...
final class TestCaseSourceLocatorFactory
{
     ...
     */
    public function __construct(ComposerJsonAndInstalledJsonSourceLocatorMaker $composerJsonAndInstalledJsonSourceLocatorMaker, Parser $phpParser, Parser $php8Parser, FileNodesFetcher $fileNodesFetcher, PhpStormStubsSourceStubber $phpstormStubsSourceStubber, ReflectionSourceStubber $reflectionSourceStubber, PhpVersion $phpVersion, array $fileExtensions, ?array $excludePaths)
    {
    ...
    public function create(): SourceLocator
    {
        ...
        $cacheKey = sha1(serialize([$this->phpVersion->getVersionId(), $this->fileExtensions, $this->excludePaths]));
