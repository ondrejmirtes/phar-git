...
final class VariadicFunctionsVisitor extends NodeVisitorAbstract
{
    ...
    public function enterNode(Node $node): ?Node
    {
        ...
        if ($this->inFunction !== null && $node instanceof Node\Expr\FuncCall && $node->name instanceof Name && in_array((string) $node->name, ParametersAcceptor::VARIADIC_FUNCTIONS, \true) && !array_key_exists($this->inFunction, $this->variadicFunctions)) {
            $this->variadicFunctions[$this->inFunction] = \true;
        }
        return null;
    }
