...
use const ENT_XML1;
final class JunitErrorFormatter implements \PHPStan\Command\ErrorFormatter\ErrorFormatter
{
    ...
    public function formatErrors(AnalysisResult $analysisResult, Output $output) : int
    {
        ...
        foreach ($analysisResult->getFileSpecificErrors() as $fileSpecificError) {
            ...
            $result .= $this->createTestCase(sprintf('%s:%s', $fileName, (string) $fileSpecificError->getLine()), 'ERROR', $fileSpecificError->getMessage());
        }
