...
class AccessoryNumericStringType implements CompoundType, \PHPStan\Type\Accessory\AccessoryType
{
    ...
    public function isSubTypeOf(Type $otherType): IsSuperTypeOfResult
    {
        ...
        return (new IsSuperTypeOfResult($otherType->isNumericString(), []))->and($otherType instanceof self ? IsSuperTypeOfResult::createYes() : IsSuperTypeOfResult::createMaybe());
    }
    ...
    {
        return new UnionType([new IntegerType(), new IntersectionType([new StringType(), new \PHPStan\Type\Accessory\AccessoryNumericStringType()])]);
    }
