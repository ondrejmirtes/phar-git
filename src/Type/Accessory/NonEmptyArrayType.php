...
class NonEmptyArrayType implements CompoundType, \PHPStan\Type\Accessory\AccessoryType
{
    ...
    public function isSubTypeOf(Type $otherType): IsSuperTypeOfResult
    {
        ...
        return (new IsSuperTypeOfResult($otherType->isArray()->and($otherType->isIterableAtLeastOnce()), []))->and($otherType instanceof self ? IsSuperTypeOfResult::createYes() : IsSuperTypeOfResult::createMaybe());
    }
