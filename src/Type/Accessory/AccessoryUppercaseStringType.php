...
class AccessoryUppercaseStringType implements CompoundType, \PHPStan\Type\Accessory\AccessoryType
{
    ...
    public function isSubTypeOf(Type $otherType): IsSuperTypeOfResult
    {
        ...
        return (new IsSuperTypeOfResult($otherType->isUppercaseString(), []))->and($otherType instanceof self ? IsSuperTypeOfResult::createYes() : IsSuperTypeOfResult::createMaybe());
    }
    ...
    public function getOffsetValueType(Type $offsetType): Type
    {
        ...
        return new IntersectionType([new StringType(), new \PHPStan\Type\Accessory\AccessoryUppercaseStringType()]);
    }
    ...
    {
        if ($type->isString()->yes() && $type->isUppercaseString()->no() && ($type->isNumericString()->no() || $this->isNumericString()->no())) {
