...
final class StrtotimeFunctionReturnTypeExtension implements DynamicFunctionReturnTypeExtension
{
    ...
    public function getTypeFromFunctionCall(FunctionReflection $functionReflection, FuncCall $functionCall, Scope $scope): Type
    {
        ...
        $results = array_unique(array_map(static fn(ConstantStringType $string) => strtotime($string->getValue()), $argType->getConstantStrings()));
        $resultTypes = array_unique(array_map(static fn($value): string => gettype($value), $results));
