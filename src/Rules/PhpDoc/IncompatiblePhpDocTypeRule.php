...
final class IncompatiblePhpDocTypeRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        return $this->check->check($scope, $node, $resolvedPhpDoc, $functionName, $this->getNativeParameterTypes($node, $scope), $this->getByRefParameters($node), $this->getNativeReturnType($node, $scope));
    }
    /**
