...
final class InvalidCallablePropertyTypeRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('Property %s::$%s cannot have callable in its type declaration.', $classReflection->getDisplayName(), $node->getName()))->identifier('property.callableType')->nonIgnorable()->build()];
    }
}
