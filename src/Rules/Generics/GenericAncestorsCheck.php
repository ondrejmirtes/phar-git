...
final class GenericAncestorsCheck
{
     ...
     */
    public function __construct(ReflectionProvider $reflectionProvider, \PHPStan\Rules\Generics\GenericObjectTypeCheck $genericObjectTypeCheck, \PHPStan\Rules\Generics\VarianceCheck $varianceCheck, UnresolvableTypeHelper $unresolvableTypeHelper, array $skipCheckGenericClasses, bool $checkMissingTypehints)
    {
