...
final class OffsetAccessValueAssignmentRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('%s does not accept %s.', $originalArrayType->describe(VerbosityLevel::value()), $assignedValueType->describe(VerbosityLevel::typeOnly())))->identifier('offsetAssign.valueType')->build()];
    }
}
