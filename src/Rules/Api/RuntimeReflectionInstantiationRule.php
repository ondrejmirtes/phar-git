...
final class RuntimeReflectionInstantiationRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('Creating new %s is a runtime reflection concept that might not work in PHPStan because it uses fully static reflection engine. Use objects retrieved from ReflectionProvider instead.', $classReflection->getName()))->identifier('phpstanApi.runtimeReflection')->build()];
    }
}
