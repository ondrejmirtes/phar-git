...
final class RuntimeReflectionFunctionRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('Function %s() is a runtime reflection concept that might not work in PHPStan because it uses fully static reflection engine. Use objects retrieved from ReflectionProvider instead.', $functionReflection->getName()))->identifier('phpstanApi.runtimeReflection')->build()];
    }
}
