...
final class OldPhpParser4ClassRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('Class %s not found. It has been renamed to %s in PHP-Parser v5.', $node->toString(), $newName))->identifier('phpParser.classRenamed')->build()];
    }
}
