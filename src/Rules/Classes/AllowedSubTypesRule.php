...
final class AllowedSubTypesRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        foreach ($parents as $parentReflection) {
            ...
            $messages[] = RuleErrorBuilder::message(sprintf('Type %s is not allowed to be a subtype of %s.', $className, $parentReflection->getName()))->identifier(sprintf('%s.disallowedSubtype', $identifierType))->build();
        }
        return $messages;
    }
}
