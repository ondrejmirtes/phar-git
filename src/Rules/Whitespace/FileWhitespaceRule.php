...
final class FileWhitespaceRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        if ($firstNode instanceof Node\Stmt\InlineHTML && $firstNode->value === "﻿") {
            $messages[] = RuleErrorBuilder::message('File begins with UTF-8 BOM character. This may cause problems when running the code in the web browser.')->identifier('whitespace.bom')->build();
        }
