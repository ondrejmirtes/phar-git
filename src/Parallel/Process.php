...
final class Process
{
    ...
    public \_PHPStan_checksum\React\ChildProcess\Process $process;
    ...
    public function start(callable $onData, callable $onError, callable $onExit) : void
    {
        ...
        $this->process = new \_PHPStan_checksum\React\ChildProcess\Process($this->command, null, null, [1 => $this->stdOut, 2 => $this->stdErr]);
