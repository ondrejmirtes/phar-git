...
namespace _PHPStan_checksum\Fidry\CpuCoreCounter;

use _PHPStan_checksum\Fidry\CpuCoreCounter\Finder\CpuCoreFinder;
use _PHPStan_checksum\Fidry\CpuCoreCounter\Finder\EnvVariableFinder;
