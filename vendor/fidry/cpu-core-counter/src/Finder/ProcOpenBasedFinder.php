...
namespace _PHPStan_checksum\Fidry\CpuCoreCounter\Finder;

use _PHPStan_checksum\Fidry\CpuCoreCounter\Executor\ProcessExecutor;
use _PHPStan_checksum\Fidry\CpuCoreCounter\Executor\ProcOpenExecutor;
