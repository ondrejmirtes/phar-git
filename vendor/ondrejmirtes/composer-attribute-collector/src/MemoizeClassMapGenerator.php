...
use _PHPStan_checksum\Composer\ClassMapGenerator\ClassMapGenerator;
...
class MemoizeClassMapGenerator
{
    ...
    public function getMap(): array
    {
         ...
         */
        $this->state = array_filter($this->state, fn(string $k): bool => $this->paths[$k] ?? \false, ARRAY_FILTER_USE_KEY);
