...
abstract class ReflectionType extends CoreReflectionType
{
    ...
    public static function fromType($betterReflectionType)
    {
        if ($betterReflectionType instanceof BetterReflectionUnionType) {
            ...
            $nonNullTypes = array_values(array_filter($betterReflectionType->getTypes(), static fn(BetterReflectionType $type): bool => !($type instanceof BetterReflectionNamedType && $type->getName() === 'null')));
