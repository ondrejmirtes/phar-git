...
final class ReflectionClassStringCast
{
    ...
    private static function constantsToString(array $constants, array $enumCases) : string
    {
        ...
        $items = array_map(static fn(ReflectionEnumCase $enumCaseReflection): string => trim(\PHPStan\BetterReflection\Reflection\StringCast\ReflectionEnumCaseStringCast::toString($enumCaseReflection, \false)), $enumCases) + array_map(static fn(ReflectionClassConstant $constantReflection): string => trim(\PHPStan\BetterReflection\Reflection\StringCast\ReflectionClassConstantStringCast::toString($constantReflection, \false)), $constants);
    ...
    private static function propertiesToString(array $properties) : string
    {
        ...
        return self::itemsToString(array_map(static fn(ReflectionProperty $propertyReflection): string => \PHPStan\BetterReflection\Reflection\StringCast\ReflectionPropertyStringCast::toString($propertyReflection, \false), $properties));
    }
    /**
    ...
    private static function methodsToString(array $methods, int $emptyLinesAmongItems = 1) : string
    {
        ...
        return self::itemsToString(array_map(static fn(ReflectionMethod $method): string => \PHPStan\BetterReflection\Reflection\StringCast\ReflectionMethodStringCast::toString($method), $methods), $emptyLinesAmongItems);
    }
    /**
