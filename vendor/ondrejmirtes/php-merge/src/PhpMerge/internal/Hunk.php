...
namespace _PHPStan_checksum\PhpMerge\internal;
...
final class Hunk
{
    ...
    public function hasIntersection(?Hunk $hunk = null)
    {
        ...
        return $this->isLineNumberAffected($hunk->start) || $this->isLineNumberAffected($hunk->end) || $hunk->isLineNumberAffected($this->start) || $hunk->isLineNumberAffected($this->end);
    }
    /**
