...
namespace _PHPStan_checksum\Nette\DI\Extensions;

use _PHPStan_checksum\Nette;
use _PHPStan_checksum\Nette\DI\Container;
use _PHPStan_checksum\Nette\DI\DynamicParameter;
use _PHPStan_checksum\Nette\PhpGenerator\Method;
/**
 * Parameters.
 */
