...
namespace _PHPStan_checksum\Nette\PhpGenerator\Traits;

use _PHPStan_checksum\Nette;
use _PHPStan_checksum\Nette\PhpGenerator\Dumper;
use _PHPStan_checksum\Nette\PhpGenerator\Parameter;
