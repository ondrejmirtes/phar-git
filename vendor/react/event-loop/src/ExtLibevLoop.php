...
namespace _PHPStan_checksum\React\EventLoop;

use BadMethodCallException;
use _PHPStan_checksum\libev\EventLoop;
use _PHPStan_checksum\libev\IOEvent;
use _PHPStan_checksum\libev\SignalEvent;
use _PHPStan_checksum\libev\TimerEvent;
use _PHPStan_checksum\React\EventLoop\Tick\FutureTickQueue;
use _PHPStan_checksum\React\EventLoop\Timer\Timer;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('_PHPStan_checksum\libev\EventLoop', \false)) {
