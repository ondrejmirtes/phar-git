...
namespace _PHPStan_checksum\React\Dns\Resolver;

use _PHPStan_checksum\React\Cache\ArrayCache;
use _PHPStan_checksum\React\Cache\CacheInterface;
use _PHPStan_checksum\React\Dns\Config\Config;
use _PHPStan_checksum\React\Dns\Config\HostsFile;
use _PHPStan_checksum\React\Dns\Query\CachingExecutor;
use _PHPStan_checksum\React\Dns\Query\CoopExecutor;
use _PHPStan_checksum\React\Dns\Query\ExecutorInterface;
use _PHPStan_checksum\React\Dns\Query\FallbackExecutor;
use _PHPStan_checksum\React\Dns\Query\HostsFileExecutor;
use _PHPStan_checksum\React\Dns\Query\RetryExecutor;
use _PHPStan_checksum\React\Dns\Query\SelectiveTransportExecutor;
use _PHPStan_checksum\React\Dns\Query\TcpTransportExecutor;
use _PHPStan_checksum\React\Dns\Query\TimeoutExecutor;
use _PHPStan_checksum\React\Dns\Query\UdpTransportExecutor;
use _PHPStan_checksum\React\EventLoop\Loop;
