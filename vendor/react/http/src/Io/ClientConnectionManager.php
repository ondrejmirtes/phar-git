...
use _PHPStan_checksum\React\EventLoop\TimerInterface;
...
class ClientConnectionManager
{
    ...
    public function connect(UriInterface $uri)
    {
        ...
        if ($scheme !== 'https' && $scheme !== 'http') {
            return \_PHPStan_checksum\React\Promise\reject(new \InvalidArgumentException('Invalid request URL given'));
        }
        $port = $uri->getPort();
        if ($port === null) {
