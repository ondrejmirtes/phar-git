...
namespace _PHPStan_checksum\React\Promise\Internal;

use _PHPStan_checksum\React\Promise\PromiseInterface;
use function _PHPStan_checksum\React\Promise\_checkTypehint;
use function _PHPStan_checksum\React\Promise\resolve;
use function _PHPStan_checksum\React\Promise\set_rejection_handler;
/**
 * @internal
 *
