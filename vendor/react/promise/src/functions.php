...
namespace _PHPStan_checksum\React\Promise;

use _PHPStan_checksum\React\Promise\Exception\CompositeException;
use _PHPStan_checksum\React\Promise\Internal\FulfilledPromise;
use _PHPStan_checksum\React\Promise\Internal\RejectedPromise;
/**
