 ...
 */
namespace _PHPStan_checksum\Symfony\Component\Console;

use _PHPStan_checksum\Symfony\Component\Console\Command\Command;
use _PHPStan_checksum\Symfony\Component\Console\Command\CompleteCommand;
use _PHPStan_checksum\Symfony\Component\Console\Command\DumpCompletionCommand;
use _PHPStan_checksum\Symfony\Component\Console\Command\HelpCommand;
use _PHPStan_checksum\Symfony\Component\Console\Command\LazyCommand;
use _PHPStan_checksum\Symfony\Component\Console\Command\ListCommand;
use _PHPStan_checksum\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PHPStan_checksum\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use _PHPStan_checksum\Symfony\Component\Console\Completion\CompletionInput;
use _PHPStan_checksum\Symfony\Component\Console\Completion\CompletionSuggestions;
use _PHPStan_checksum\Symfony\Component\Console\Event\ConsoleCommandEvent;
use _PHPStan_checksum\Symfony\Component\Console\Event\ConsoleErrorEvent;
use _PHPStan_checksum\Symfony\Component\Console\Event\ConsoleSignalEvent;
use _PHPStan_checksum\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use _PHPStan_checksum\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PHPStan_checksum\Symfony\Component\Console\Exception\ExceptionInterface;
use _PHPStan_checksum\Symfony\Component\Console\Exception\LogicException;
use _PHPStan_checksum\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use _PHPStan_checksum\Symfony\Component\Console\Exception\RuntimeException;
use _PHPStan_checksum\Symfony\Component\Console\Formatter\OutputFormatter;
use _PHPStan_checksum\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PHPStan_checksum\Symfony\Component\Console\Helper\FormatterHelper;
use _PHPStan_checksum\Symfony\Component\Console\Helper\Helper;
use _PHPStan_checksum\Symfony\Component\Console\Helper\HelperSet;
use _PHPStan_checksum\Symfony\Component\Console\Helper\ProcessHelper;
use _PHPStan_checksum\Symfony\Component\Console\Helper\QuestionHelper;
use _PHPStan_checksum\Symfony\Component\Console\Input\ArgvInput;
use _PHPStan_checksum\Symfony\Component\Console\Input\ArrayInput;
use _PHPStan_checksum\Symfony\Component\Console\Input\InputArgument;
use _PHPStan_checksum\Symfony\Component\Console\Input\InputAwareInterface;
use _PHPStan_checksum\Symfony\Component\Console\Input\InputDefinition;
...
use _PHPStan_checksum\Symfony\Component\Console\Output\ConsoleOutput;
...
use _PHPStan_checksum\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use _PHPStan_checksum\Symfony\Component\Console\Style\SymfonyStyle;
use _PHPStan_checksum\Symfony\Component\ErrorHandler\ErrorHandler;
use _PHPStan_checksum\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use _PHPStan_checksum\Symfony\Contracts\Service\ResetInterface;
/**
