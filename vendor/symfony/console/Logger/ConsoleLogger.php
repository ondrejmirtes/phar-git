 ...
 */
namespace _PHPStan_checksum\Symfony\Component\Console\Logger;

use _PHPStan_checksum\Psr\Log\AbstractLogger;
use _PHPStan_checksum\Psr\Log\InvalidArgumentException;
use _PHPStan_checksum\Psr\Log\LogLevel;
