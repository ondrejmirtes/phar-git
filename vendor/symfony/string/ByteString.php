 ...
 */
namespace _PHPStan_checksum\Symfony\Component\String;

use _PHPStan_checksum\Symfony\Component\String\Exception\ExceptionInterface;
use _PHPStan_checksum\Symfony\Component\String\Exception\InvalidArgumentException;
use _PHPStan_checksum\Symfony\Component\String\Exception\RuntimeException;
/**
...
class ByteString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\d])([A-Z])/'], '_PHPStan_checksum\1_\2', $str->string));
        return $str;
    }
