 ...
 */
namespace _PHPStan_checksum\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PHPStan_checksum\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PHPStan_checksum\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PHPStan_checksum\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PHPStan_checksum\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PHPStan_checksum\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PHPStan_checksum\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
